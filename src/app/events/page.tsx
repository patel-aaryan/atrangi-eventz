      ...
      <section className="relative overflow-hidden pt-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Experience the best of Gujarati culture through our exciting
              events. From high-energy Bollywood club nights to traditional
              Garba celebrations, there&apos;s something for everyone.
            </motion.p>
          </motion.div>
          ...
          >
            <motion.div variants={fadeInUp} className="text-center">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Stay tuned for our next events. Follow us on social media for
                the latest announcements and early bird tickets.
              </p>
            </motion.div>
